  ...
  return (
    <div className="container mx-auto pb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 mb-10">
        <Link href={`/races/${year}/${racesLast.round}`} className="border border-white/10 rounded-2xl p-4 bg-white/5 backdrop-blur shadow-lg">
        ...
        <Link href={`/races/${year}/${racesNext.round}`} className="border border-white/10 rounded-2xl p-4 bg-white/5 backdrop-blur shadow-lg">
          <h4 className="text-xl font-black mb-2 tracking-wide uppercase">
            Next Race
          </h4>
